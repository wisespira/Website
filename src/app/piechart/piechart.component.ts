...
export class PiechartComponent implements OnInit {
  ...
  {title:'PWA/Angular',num:2,colour:'rgba(0, 122, 168,1)',info:{projs: [{title:'Porfolio Website ;)',body:'The website your viewing code on Github link down below',giff:'https://raw.githubusercontent.com/wisespira/Website/master/its%20the%20giff.gif',showGiff:false},{title:'Newcastle uni tab for Embended in microsoft teams',body:'While working microsft to help microsoft teams integration I developed a PWA replicating the mobile apps featers set hosted it on firebase and embeded it in my teams app tab'}]}},
  {title:'ionic3',num:3,colour:'rgba(2, 56, 110,1)',info:{projs: [{title:'Newcastle Uni App',body:'I developed and deployed multipul realeses for the app on android and ios'},{title:'Peseptron App',body:'An app I produced for android and ios implementing the p5js libary graphicaly show the learning proceses of a basic neural network',giff:'https://raw.githubusercontent.com/wisespira/Ionic-App-Perceptron/master/giff.gif', showGiff:false},{title:'L system App',body:'An app which shows that graphically shows the generation of complex patterns from a simple rule set.'}]}},
  ...
  {title:'p5js',num:3,colour:'rgba(254, 204, 81,1)',info:{projs: [{title:'L-System',body:'Graphically shows the generation of complex patterns from a simple rule set.',giff:'https://raw.githubusercontent.com/wisespira/L-System/master/its%20the%20giff.gif', showGiff:false},{title:'MetaBalls',body:'Graphically creates organic-looking n-dimensional objects'},{title:'Fractal trees',body:'Generates nice Fractal trees'}]}},
